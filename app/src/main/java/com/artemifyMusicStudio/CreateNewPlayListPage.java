...
public class CreateNewPlayListPage extends PageActivity implements RadioGroup.OnCheckedChangeListener {
    ...
    protected void populateIdMenuMap() {
        ...
        idMenuItemMap.put(CommandItemType.CREATE_NEW_PLAYLIST, R.id.create_playlist);
    }
    ...
    protected void populateMenuCommandCreatorMap() {
        ...
        ArrayList<CommandItemType> tempList2 = new ArrayList<>(
                List.of(CommandItemType.CREATE_NEW_PLAYLIST)
        );
    ...
    private void resetCreateListener(){
        ...
        create.setOnClickListener(creator.create(CommandItemType.CREATE_NEW_PLAYLIST));
    }
}